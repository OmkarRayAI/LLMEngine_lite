...
class AutomatedToolGenerator:
    ...
    def _discover_tools(self):
        ...
        # Since tool_generator.py is in LLMEngine/, and tools is LLMEngine/tools/
        # We need to import as "LLMEngine.tools.module_name"
        import sys
        
        # Get the parent directory of tools folder (should be LLMEngine)
        parent_dir = os.path.dirname(self.tools_folder_path)
        package_name = os.path.basename(parent_dir)  # Should be "LLMEngine"
